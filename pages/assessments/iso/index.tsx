    ...
    <>
      ...
      <div className="heading heading-lg">
        <div className="container container-fluid container-1200 d-flex align-items-center justify-content-between">
            <h1>ISO</h1>
            <div>
              <Link href="/assessments/iso/new" className="btn btn-lg btn-secondary"><div className="fs-14">Add new</div></Link>
            </div>
        </div>
      </div>
        ...
        <table className="table-primary mt-5">
          ...
          <tbody>
              <tr>
                  ...
                  <td>
                      <Link href="/assessments/iso/20001-2018">
                          <div className="color-default primary-cell"><span>20001-2018</span></div>
                      </Link>
                  </td>
                  <td>
              ...
              <tr>
                  ...
                  <td>
                      <Link href="/">
                          <div className="color-default primary-cell"><span>9001-2015</span></div>
                      </Link>
                  </td>
                  <td>
                      <div>Specific</div>
              ...
              <tr>
                  ...
                  <td>
                      <Link href="/">
                          <div className="color-default primary-cell"><span>27001</span></div>
                      </Link>
                  </td>
                  <td>
                      <div>General maturity</div>
