    ...
    <>
      ...
      <div className="container container-fluid container-1200 mt-40">
        <div className="row">
            ...
            <div className="col-4">
                <IsoMethod className="" btnClassName="btn btn-secondary btn-lg btn-max" menuClassName="dropdown-primary" dropDownButtonLabel="Select assessment type"></IsoMethod>
            </div>
        </div>
        <div className="mt-40">
          <div className="d-flex align-items-center justify-content-center infobox">
            <div>
              <div className="fs-14 fw-400">Select assessment type</div>
            </div>
          </div>
        </div>
      </div>
