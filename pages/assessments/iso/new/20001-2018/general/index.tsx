    ...
    <>
      ...
      <div className="container container-fluid container-1200 mt-40">
        <div className="row">
            ...
            <div className="col-4">
                <IsoMethod className="" btnClassName="btn btn-secondary btn-lg btn-max" menuClassName="dropdown-primary" dropDownButtonLabel="General maturity"></IsoMethod>
            </div>
        </div>
        ...
        <div className="mt-20 d-flex justify-content-between">
          <div></div>
          <div><Link href="/assessments/iso/new/20001-2018/general/quiz" className="btn btn-lg btn-primary"><div className="fs-14">Start assessment</div></Link></div>
        </div>
      </div>
    </>
  )
