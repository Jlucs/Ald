                ...
                <div className="cell-inner">
                  <div className="d-flex flex-row align-items-center">
                    ...
                    <div className="d-flex w-100">
                      ...
                      <input className="table-input" defaultValue="Understanding the needs and expectations of interested parties."/>
                    </div>  
                  </div>
                </div>
              </div>
              ...
              <div className="grid-cell" style={{flex: "1"}}>
                <div className="cell-inner">
                  <div className="d-flex flex-row align-items-center">
                    ...
                    <div className="d-flex w-100">
                      {/* <InputEdit initialValue="Application Consolidation Project" /> */}
                      <input className="table-input" defaultValue="Determining the scope of the service management"/>
                    </div>  
                  </div>
                </div>
              </div>
              ...
              <div className="grid-cell" style={{flex: "1"}}>
                <div className="cell-inner">
                  <div className="d-flex flex-row align-items-center">
                    ...
                    <div className="d-flex w-100">
                      {/* <InputEdit initialValue="Application Consolidation Project" /> */}
                      <input className="table-input" defaultValue="Organizational roles, responsibilities and authorities"/>
                    </div>  
                  </div>
                </div>
              </div>
              ...
              <div className="grid-cell" style={{flex: "1"}}>
                <div className="cell-inner">
                  <div className="d-flex flex-row align-items-center">
                    ...
                    <div className="d-flex w-100">
                      {/* <InputEdit initialValue="Application Consolidation Project" /> */}
                      <input className="table-input" defaultValue="Address risks and opportunities"/>
                    </div>  
                  </div>
                </div>
              </div>
              ...
              <div className="grid-cell" style={{flex: "1"}}>
                <div className="cell-inner">
                  <div className="d-flex flex-row align-items-center">
                    ...
                    <div className="d-flex w-100">
                      {/* <InputEdit initialValue="Application Consolidation Project" /> */}
                      <input className="table-input" defaultValue="Operational planning and control"/>
                    </div>  
                  </div>
                </div>
              </div>
