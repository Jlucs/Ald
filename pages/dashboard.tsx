...
const Page: NextPageWithLayout = () => {
    useEffect( () => {
        ...
        document.body.classList.add("header-enabled", "subheader-enabled", "bg-accent-1");
        return () => {
            body?.classList.remove("header-enabled", "subheader-enabled", "bg-accent-1");
        }
    });
  return (
    <>
      ...
      <div className="container container-fluid container-1440 mt-40">
        <h1 className="h1-primary fw-600">The home for all organizations — including you.</h1>
        <p className="mb-40 container-840 lh-160">Welcome to your personal dashboard, where you can find an introduction to how Aldameiry works, tools to help you improve organizations workflow, and help you create your first assessment.</p>
        <div className="row">
            ...
            <div className="card card-primary shadow card-stretch gutter-b">
              <div className="card-body">
                ...
                <div className="box box-primary">
                  <div>
                    <p className="mb-20 fc-accent-6 text-center container-480 m-auto">Select your preferred way to create a new assessment, we&apos;ll help you along the way.</p>
                    <div className="p-25 container-320 m-auto">
                      <Link href="/new" className="btn btn-primary btn-lg fs-13">
                        <div className="d-flex">
                          <div className="fs-13 mr-10"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M0 0H224V160H384V512H0V0zM384 128H256V0L384 128z"/></svg></div>
                          <div>Continue with assessment</div>
                        </div>
                      </Link>
                      <Link href="/new" className="btn btn-dark btn-lg fs-13 mb-8 mt-8">
                        <div className="d-flex">
                          <div className="fs-13 mr-10"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 448c106 0 192-86 192-192s-86-192-192-192S64 150 64 256c0 3.9 .1 7.8 .4 11.7L1.8 286.1C.6 276.2 0 266.2 0 256C0 114.6 114.6 0 256 0S512 114.6 512 256s-114.6 256-256 256c-10.2 0-20.2-.6-30.1-1.8l18.4-62.6c3.9 .2 7.8 .4 11.7 .4zm2.3-48l19.7-67c33.5-9.6 58-40.4 58-76.9c0-44.2-35.8-80-80-80c-36.5 0-67.4 24.5-76.9 58L112 253.7C113.2 175.2 177.2 112 256 112c79.5 0 144 64.5 144 144c0 78.8-63.2 142.8-141.7 144zM0 320l272-80L192 512l-48-96-1.4-1.4-96 96L1.4 465.4l96-96L96 368 0 320z"/></svg></div>
                          <div>Continue with benchmark</div>
                        </div>
                      </Link>
                    </div>
                  </div>
                </div>
                <div className="mt-20"><Link href="/new" className="link link-primary ">View more assessment options →</Link></div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 mb-20">
            <div className="row h-100">
              <div className="col-6 mb-20">
                <Link href="/assessments" className="d-flex card card-primary h-50 shadow mb-20 align-items-center justify-content-center">
                  <div className="card-body d-flex flex-column">
                    <div className="text-center mb-20">
                      <svg className="svg-100" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href="" className="d-flex card card-primary h-50 shadow mb-20 align-items-center justify-content-center">
                  <div className="card-body d-flex flex-column">
                    <div className="text-center mb-20">
                      <svg className="svg-100" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="col-6 mb-20">
              <Link href="/activity" className="d-flex card card-primary h-50 shadow mb-20 align-items-center justify-content-center">
                  <div className="card-body d-flex flex-column">
                    <div className="text-center mb-20">
                      <svg className="svg-100" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href="" className="d-flex card card-primary h-50 shadow mb-20 align-items-center justify-content-center">
                  <div className="card-body d-flex flex-column">
                    ...
                    <h3 className="text-center">Aldameiry AI</h3>
                  </div>
                </Link>
              </div>
            </div>
