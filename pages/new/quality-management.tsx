                            ...
                            <div className="item">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        <div className="mr-10">
                                            <svg className="svg-blue" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity="0.3" d="M19 22H5C4.4 22 4 21.6 4 21V3C4 2.4 4.4 2 5 2H14L20 8V21C20 21.6 19.6 22 19 22Z" fill="currentColor"></path><path d="M15 8H20L14 2V7C14 7.6 14.4 8 15 8Z" fill="currentColor"></path></svg>
                                        </div>
                                        <div className="fs-13">ISO 20001-2018</div>
                                    </div>
                                    <div>
                                        <Link href="/new/iso/20001-2018/general" className="btn btn-primary btn-sm fs-13"><div>Continue</div></Link>
                                    </div>
                                </div>
                            </div>
                            <div className="item">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="fs-13">ISO 27001</div>
                                    </div>
                                    <div>
                            ...
                            <div className="item">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="fs-13">9001-2015 Quality management systems</div>
                                    </div>
                                    <div>
                                        <Link href="" className="btn btn-primary btn-sm fs-13"><div>Continue</div></Link>
                                    </div>
                            ...
                            <div className="item">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="fs-13">6SIGMA</div>
                                    </div>
                                    <div>
                                        <Link href="" className="btn btn-primary btn-sm fs-13"><div>Continue</div></Link>
                                    </div>
                            ...
                            <div className="item">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="fs-13 pr-40">ISO/IEC 27001:2022 Information security, cybersecurity and privacy protection</div>
                                    </div>
                                    <div>
                                        <Link href="" className="btn btn-primary btn-sm fs-13"><div>Continue</div></Link>
                                    </div>
                            ...
                            <div className="item">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="fs-13">ISO 14001:2015 Environmental management systems</div>
                                    </div>
                                    <div>
                                        <Link href="" className="btn btn-primary btn-sm fs-13"><div>Continue</div></Link>
                                    </div>
                            ...
                            <div className="item">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="fs-13">ISO 45000 family — Occupational health and safety</div>
                                    </div>
                                    <div>
                                        <Link href="" className="btn btn-primary btn-sm fs-13"><div>Continue</div></Link>
                                    </div>
                            ...
                            <div className="item">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="fs-13">ISO 31000 — Risk management</div>
                                    </div>
                                    <div>
                                        <Link href="" className="btn btn-primary btn-sm fs-13"><div>Continue</div></Link>
                                    </div>
                            ...
                            <div className="item">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="fs-13">ISO 37000:2021 Governance of organizations</div>
                                    </div>
                                    <div>
                                        <Link href="" className="btn btn-primary btn-sm fs-13"><div>Continue</div></Link>
                                    </div>
                            ...
                            <div className="item">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="fs-13">ISO 22301 Business Continuity Management</div>
                                    </div>
                                    <div>
                                        <Link href="" className="btn btn-primary btn-sm fs-13"><div>Continue</div></Link>
                                    </div>
                            ...
                            <div className="item">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="fs-13">ISO 20001-2018 Information technology service management </div>
                                    </div>
                                    <div>
                                        <Link href="" className="btn btn-primary btn-sm fs-13"><div>Continue</div></Link>
                                    </div>
